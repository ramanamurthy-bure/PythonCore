...
# So that pricing the product name we can get the price easily
print("######################  (1) ############################################")
mydict = {'key1': 'value1', 'key2': 'value2', 'key3': 'value3', 'key4': 'value4'}
print(mydict)
print("######################  (2) ############################################")
d = {'k1': 123, 'k2': [0, 2, 1, 13, 5],
     'k3': {'insidekey1': {'childkey1': 1, 'childkey2': 2, 'childkey3': 3}, 'insidekey2': 140, 'insidekey3': 150}}
print(d)
print(d['k2'][3])  # 13
