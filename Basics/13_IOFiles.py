...
print("######################  (1) ############################################")
file = open("/Resources/Sample.txt", "w")  # open for writing
file.write("Hello this is a text file")
file.write("\nThis is a second line")
file.write("\nThis is a third line")
file.close()
print("######################  (2) ############################################")
file = open("/Resources/Sample.txt", "r")  # open for reading
...
print("Reading again before resetting the cursor :",
      file.read())  # This will give empty string as the cursor is at end of the file
file.seek(0)  # This will set the cursor back to the starting
print("Reading again after resetting the cursor to 0 :", file.read())
# This will give the all the text in one string
...
# path is in the form:
myfile = open("/Resources/Sample.txt")
print("######################  (7) ############################################")
